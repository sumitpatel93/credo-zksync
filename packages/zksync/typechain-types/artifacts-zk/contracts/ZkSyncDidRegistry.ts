...
export interface ZkSyncDidRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addDelegate"
      | "attributes"
...
export interface ZkSyncDidRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ZkSyncDidRegistry;
  waitForDeployment(): Promise<this>;

  interface: ZkSyncDidRegistryInterface;
